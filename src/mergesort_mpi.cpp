...
void computeChunksAndProcess(const std::string& filename, size_t num_nodes, size_t num_threads, const std::string& run_prefix) {
...
void master(const std::string& filename) {
